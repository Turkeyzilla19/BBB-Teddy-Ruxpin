...
class AudioPlayer:
  def __init__(self):
    subprocess.Popen('amixer cset numid=1 100%' ,shell=True, stdout=subprocess.PIPE )
    subprocess.Popen('amixer cset numid=2 2' ,shell=True, stdout=subprocess.PIPE )
    subprocess.Popen('amixer cset numid=3 1' ,shell=True, stdout=subprocess.PIPE )
    subprocess.Popen('amixer cset numid=4 1' ,shell=True, stdout=subprocess.PIPE )
